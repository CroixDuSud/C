/* ========================================================================== */
/* projet : TP sur les Tableaux     Décomposition d'un nombre entier          */
/* fichier : tablDecomp.c                                                     */
/* -------------------------------------------------------------------------- */
/* Trouver toutes les combinaisons de nombres positifs différents             */
/*     dont le total est égal à l'entier saisi                                */
/* -------------------------------------------------------------------------- */
