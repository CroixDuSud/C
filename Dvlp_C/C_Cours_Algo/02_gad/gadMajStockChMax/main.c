...
/* mouvements                                                                 */
/* -------------------------------------------------------------------------- */
/* Version avec utilisation de chaine_max() pour les fins de fichier          */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
   ...
   if (feof(fichierAS))
      chaine_max(produitAS.numero, sizeof(produitAS.numero));

   fread(&mouvement, sizeof(MOUVEMENT), 1, fichierMouvements);
   if (feof(fichierMouvements))
      chaine_max(mouvement.numeroProduit, sizeof(mouvement.numeroProduit));
...
/* -------------------------------------------------------------------------- */
            fread(&mouvement, sizeof(MOUVEMENT), 1, fichierMouvements);
            if (feof(fichierMouvements))
               chaine_max(mouvement.numeroProduit,
