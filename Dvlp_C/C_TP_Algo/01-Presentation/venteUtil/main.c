/* ========================================================================== */
/* Projet : venteUtil -- Statistique des ventes                               */
/* -------------------------------------------------------------------------- */
/* Version utilisant des utilitaires de gestion des chaines                   */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
         ...
         doubleChaine(z05, 2, 1, '.', chaineNum);
...
/* -------------------------------------------------------------------------- */
      ...
      doubleChaine(z06, 2, 1, '.', chaineNum);
      placeSousChaine(lt2, chaineNum, 35, 'g');
      doubleChaine(z07, 2, 1, '.', chaineNum);
      placeSousChaine(lt2, chaineNum, 52, 'g');
      doubleChaine(z08, 2, 1, '.', chaineNum);
...
/* -------------------------------------------------------------------------- */
   ...
   doubleChaine(z09, 2, 1, '.', chaineNum);
   placeSousChaine(lt3, chaineNum, 35, 'g');
   doubleChaine(z10, 2, 1, '.', chaineNum);
   placeSousChaine(lt3, chaineNum, 52, 'g');
   doubleChaine(z11, 2, 1, '.', chaineNum);
